...
namespace flang {
    ...
    public:
        ...
        static flang::FResult createError(ErrorType err_type, std::string_view msg, const Token &tok);
    ...
    public:
        ...
        virtual flang::FResult
        callProperty(Interpreter &visitor, const std::shared_ptr<flang::FunctionCallNode> &fn_node);
        ...
        virtual flang::FResult
        call(Interpreter &visitor, std::vector<std::shared_ptr<Object>> &arguments, const Token &token);
...
// Derived classes for specific types
    ...
    private:
        ...
        get(StringObject &str, flang::Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);

        static flang::FResult
        split(StringObject &str, Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);

        static flang::FResult
        to_int(StringObject &str, Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);

        static flang::FResult
        to_float(StringObject &str, Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);

        static flang::FResult
        to_lower(StringObject &str, Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);

        static flang::FResult
        to_upper(StringObject &str, Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);

        static flang::FResult
        is_digit(StringObject &str, Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);

        static flang::FResult
        is_alpha(StringObject &str, Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);
    ...
    private:
        // functions
        static flang::FResult
        get(ListObject &list, flang::Interpreter &visitor, const std::shared_ptr<FunctionCallNode> &fn_node);
    ...
    public:
        ...
        flang::FResult
        call(Interpreter &visitor, std::vector<std::shared_ptr<Object>> &args, const Token &token) override;
    };

    class BuiltinFunctionObject : public Object {
    public:
        typedef flang::FResult (*FunctionPointer)(Interpreter &, const std::vector<std::shared_ptr<Object>> &,
        ...
        flang::FResult
        call(Interpreter &visitor, std::vector<std::shared_ptr<Object>> &arguments, const Token &token) override;
    };
    ...
    public:
        ...
        ErrorObject(ErrorType _err_type, std::string_view _err_msg, const Position &pos, Token tok) :
                Object(std::move(tok)), err_type(_err_type), err_msg(_err_msg) {}
